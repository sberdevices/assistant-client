    ...
    $root.Message = (function () {
        ...
        Message.verify = function verify(message) {
            ...
            if (message.messageId != null && message.hasOwnProperty('messageId'))
                if (
                    !$util.isInteger(message.messageId) &&
                    !(
                        message.messageId &&
            ...
            if (message.last != null && message.hasOwnProperty('last'))
                if (!$util.isInteger(message.last)) return 'last: integer expected';
            ...
            if (message.userChannel != null && message.hasOwnProperty('userChannel'))
                if (!$util.isString(message.userChannel)) return 'userChannel: string expected';
            if (message.vpsToken != null && message.hasOwnProperty('vpsToken'))
                if (!$util.isString(message.vpsToken)) return 'vpsToken: string expected';
            ...
            if (message.messageName != null && message.hasOwnProperty('messageName'))
                if (!$util.isString(message.messageName)) return 'messageName: string expected';
        ...
        Message.fromObject = function fromObject(object) {
            ...
            if (object.messageId != null)
                if ($util.Long) (message.messageId = $util.Long.fromValue(object.messageId)).unsigned = false;
                else if (typeof object.messageId === 'string') message.messageId = parseInt(object.messageId, 10);
                else if (typeof object.messageId === 'number') message.messageId = object.messageId;
                else if (typeof object.messageId === 'object')
                    message.messageId = new $util.LongBits(
                        object.messageId.low >>> 0,
                        object.messageId.high >>> 0,
                    ).toNumber();
    ...
    $root.Device = (function () {
        ...
        Device.verify = function verify(message) {
            ...
            if (message.platformType != null && message.hasOwnProperty('platformType'))
                if (!$util.isString(message.platformType)) return 'platformType: string expected';
            ...
            if (message.surface != null && message.hasOwnProperty('surface'))
                if (!$util.isString(message.surface)) return 'surface: string expected';
            if (message.surfaceVersion != null && message.hasOwnProperty('surfaceVersion'))
                if (!$util.isString(message.surfaceVersion)) return 'surfaceVersion: string expected';
            if (message.features != null && message.hasOwnProperty('features'))
                if (!$util.isString(message.features)) return 'features: string expected';
            if (message.capabilities != null && message.hasOwnProperty('capabilities'))
                if (!$util.isString(message.capabilities)) return 'capabilities: string expected';
            ...
            if (message.deviceManufacturer != null && message.hasOwnProperty('deviceManufacturer'))
                if (!$util.isString(message.deviceManufacturer)) return 'deviceManufacturer: string expected';
            if (message.deviceModel != null && message.hasOwnProperty('deviceModel'))
                if (!$util.isString(message.deviceModel)) return 'deviceModel: string expected';
    ...
    $root.Settings = (function () {
        ...
        Settings.verify = function verify(message) {
            ...
            if (message.dubbing != null && message.hasOwnProperty('dubbing'))
                if (!$util.isInteger(message.dubbing)) return 'dubbing: integer expected';
            ...
            if (message.ttsEngine != null && message.hasOwnProperty('ttsEngine'))
                if (!$util.isString(message.ttsEngine)) return 'ttsEngine: string expected';
            if (message.asrEngine != null && message.hasOwnProperty('asrEngine'))
                if (!$util.isString(message.asrEngine)) return 'asrEngine: string expected';
            if (message.asrAutoStop != null && message.hasOwnProperty('asrAutoStop'))
                if (!$util.isInteger(message.asrAutoStop)) return 'asrAutoStop: integer expected';
            if (message.devMode != null && message.hasOwnProperty('devMode'))
                if (!$util.isInteger(message.devMode)) return 'devMode: integer expected';
            if (message.authConnector != null && message.hasOwnProperty('authConnector'))
                if (!$util.isString(message.authConnector)) return 'authConnector: string expected';
            if (message.surface != null && message.hasOwnProperty('surface'))
                if (!$util.isString(message.surface)) return 'surface: string expected';
            return null;
        };
    ...
    $root.LegacyDevice = (function () {
        ...
        LegacyDevice.verify = function verify(message) {
            ...
            if (message.clientType != null && message.hasOwnProperty('clientType'))
                if (!$util.isString(message.clientType)) return 'clientType: string expected';
            ...
            if (message.channelVersion != null && message.hasOwnProperty('channelVersion'))
                if (!$util.isString(message.channelVersion)) return 'channelVersion: string expected';
            if (message.platformName != null && message.hasOwnProperty('platformName'))
                if (!$util.isString(message.platformName)) return 'platformName: string expected';
            if (message.platformVersion != null && message.hasOwnProperty('platformVersion'))
                if (!$util.isString(message.platformVersion)) return 'platformVersion: string expected';
            if (message.sdkVersion != null && message.hasOwnProperty('sdkVersion'))
                if (!$util.isString(message.sdkVersion)) return 'sdkVersion: string expected';
            if (message.protocolVersion != null && message.hasOwnProperty('protocolVersion'))
                if (!$util.isString(message.protocolVersion)) return 'protocolVersion: string expected';
            return null;
        };
    ...
    $root.Status = (function () {
        ...
        Status.verify = function verify(message) {
            ...
            if (message.technicalDescription != null && message.hasOwnProperty('technicalDescription'))
                if (!$util.isString(message.technicalDescription)) return 'technicalDescription: string expected';
            return null;
        };
    ...
    $root.DevContext = (function () {
        ...
        DevContext.fromObject = function fromObject(object) {
            ...
            if (object.timestampMs != null)
                if ($util.Long) (message.timestampMs = $util.Long.fromValue(object.timestampMs)).unsigned = false;
                else if (typeof object.timestampMs === 'string') message.timestampMs = parseInt(object.timestampMs, 10);
                else if (typeof object.timestampMs === 'number') message.timestampMs = object.timestampMs;
